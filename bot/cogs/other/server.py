from discord.ext.commands import Bot, ExtensionError, MissingRequiredArgument, Cog

import os


class ManageServer(Cog):
    def __init__(self, bot: Bot):
        self.bot = bot

    async def use_cogs(self, path: str, ext: str, method: str) -> list[tuple, str]:
        ...
        for cog in extensions:
            try:
                await getattr(self.bot, f'{method}_extension')(cog)
...
async def setup(bot: Bot):
    await bot.add_cog(ManageServer(bot))
